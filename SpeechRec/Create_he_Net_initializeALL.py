...
#
    if(rnd_init):
        L1 = Conv1D(n_channels[0], k, padding='same',kernel_initializer=kinit.he_normal(), kernel_regularizer=regularizers.l2(weight_decay)
    ...
    if(n_clayers == 2):
        if(rnd_init):
            L4 = Conv1D(n_channels[1], k, padding='same',kernel_initializer=kinit.he_normal(), kernel_regularizer=regularizers.l2(weight_decay),strides=int(S[1]),name='conv2')(L3)
        else:
        ...
        L8 = Dropout(0.2)(L7)
        if(rnd_init):
            L9 = Conv1D(n_channels[2], k, padding='same',kernel_initializer=kinit.he_normal(), kernel_regularizer=regularizers.l2(weight_decay),strides=int(S[2]),name='conv3')(L8)
        else:
        ...
        L11 = BatchNormalization()(L10)
        if(rnd_init):
            L12 = Conv1D(n_channels[3], k, padding='same',kernel_initializer=kinit.he_normal(), kernel_regularizer=regularizers.l2(weight_decay),strides=int(S[3]),name='conv4')(L11)
        else:
        ...
        L16 = Dropout(0.3)(L15)
        if(rnd_init):
            L17 = Conv1D(n_channels[4], k, padding='same',kernel_initializer=kinit.he_normal(), kernel_regularizer=regularizers.l2(weight_decay),strides=int(S[4]),name='conv5')(L16)
        else:
        ...
        L16 = Dropout(0.3)(L15)
        if(rnd_init):
            L17 = Conv1D(n_channels[4], k, padding='same',kernel_initializer=kinit.he_normal(), kernel_regularizer=regularizers.l2(weight_decay)
        ...
        L18 = Activation('relu')(L17)
        L19 = BatchNormalization()(L18)
        L20 = Conv1D(n_channels[5], k, padding='same',kernel_initializer=kinit.he_normal(),
    ...
    if(rnd_init):
        Ld = Dense(num_classes, activation='softmax',name='dense',
                   kernel_initializer=kinit.he_normal())(Lc)
    else:
        Ld = Dense(num_classes, activation='softmax',name='dense',
