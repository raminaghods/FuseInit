...
#
    k = 3
    if(rnd_init):
        L1 = Conv2D(32, (3,3), padding='same',kernel_initializer=kinit.he_normal(), kernel_regularizer=regularizers.l2(weight_decay)
    ...
    if(n_clayers == 1):
        ...
        Lc_a0 = Flatten()(L3)
        if(rnd_init):
            L4 = Conv2D(32, (k,k), padding='same',kernel_initializer=kinit.he_normal(), kernel_regularizer=regularizers.l2(weight_decay),name='conv2')(L3)
        else:
        ...
        L8 = Dropout(0.2)(L7)
        if(rnd_init):
            L9 = Conv2D(64, (k,k), padding='same',kernel_initializer=kinit.he_normal(), kernel_regularizer=regularizers.l2(weight_decay),name='conv3')(L8)
        else:
        ...
        L11 = BatchNormalization()(L10)
        if(rnd_init):
            L12 = Conv2D(64, (k,k), padding='same',kernel_initializer=kinit.he_normal(), kernel_regularizer=regularizers.l2(weight_decay),name='conv4')(L11)
        else:
        ...
        L16 = Dropout(0.3)(L15)
        if(rnd_init):
            L17 = Conv2D(128, (k,k), padding='same',kernel_initializer=kinit.he_normal(), kernel_regularizer=regularizers.l2(weight_decay),name='conv5')(L16)
        else:
        ...
        L18 = Activation('elu')(L17)
        L19 = BatchNormalization()(L18)
        L20 = Conv2D(128, (k,k), padding='same',kernel_initializer=kinit.he_normal(), kernel_regularizer=regularizers.l2(weight_decay),name='conv6')(L19)
